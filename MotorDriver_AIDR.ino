// Some code added by Amjad for ROS
#include <ros.h>
...
void dutyCallback(const std_msgs::Int16MultiArray& msg){
   ...
   // Duty ratio for THIS motor (one will have 0 and the other will have 1)
   D = myDuty; // both motors either move forward or backward (the difference between them rotates the robot)
}
// -------- /MessageCallbacks --------
